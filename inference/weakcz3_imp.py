...
class WeakCz3IMP():
    ...
    def compile_constraints(self):
        ...
        objectives = {j:opt.add_soft(c.make_A_then_not_B() == False, id=j) for j,c in self.bb.conditionals.items() if j in J_delta_keys}    #setting id's to setup multidimensional pareto optimization
