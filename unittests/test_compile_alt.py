...
from pysmt.shortcuts import BOOL, Not, Symbol
...
class TestCompileAlt(unittest.TestCase):
    ...
    def test_compile_alt_conditional_acceptance_logic(self):
        ...
        self.assertTrue(
            self.mock_ranking_function.world_satisfies_conditionalization.called
        )
    ...
    def test_compile_alt_multiple_conditionals(self):
        ...
        multiple_conditionals = [
            self.mock_conditional_1,
            self.mock_conditional_2,
            mock_conditional_3,
        ]
...
class TestCompileAltIntegration(unittest.TestCase):
    ...
    def test_compile_alt_with_real_conditionals(self):
        ...
        conditional2 = Conditional(
            consequence=Not(a), antecedence=b, textRepresentation="(!a|b)"
        )
        ...
        mock_ranking_function.world_satisfies_conditionalization.side_effect = cycle(
            [True, False]
        )
