...
from inference.c_revision import compile_alt, compile
...
class TestCompileContentComparison(unittest.TestCase):
    ...
    def test_same_logical_content_different_structure(self):
        ...
        self.mock_ranking_function.world_satisfies_conditionalization.side_effect = track_world_satisfaction
